...
"""burdaki 0ı unutma!, çünkü histogram eşitleme ve clahe gibi yoğunluk dönüşümleri gri tonlamalı fotoğraflar 
üzerinde çalışır."""
...
cv2.imwrite(os.path.join(os.path.dirname(path), "orginal.jpg"), img)

cv2.imshow('orginal', img)
cv2.imshow("global_eq", global_eq)
cv2.imshow("img_orginal", img_orginal)
